...
three_phase_models = ["SolarPVDERThreePhase","SolarPVDERThreePhaseNoVrmsFilter","SolarPVDERThreePhaseConstantVdc","SolarPVDERThreePhaseBalanced","SolarPVDERThreePhaseNumba"]
...
model_types = ['SinglePhase','SinglePhaseConstantVdc',
			   'ThreePhaseUnbalanced','ThreePhaseUnbalancedConstantVdc','ThreePhaseBalanced','ThreePhaseUnbalancedNumba','ThreePhaseUnbalancedNoVrmsFilter']
