...
class SolarPVDERThreePhaseNumba(PVModule,SolarPVDER):
	...
	def update_RMS(self):
		...
		try:
			...
			if self.DO_EXTRA_CALCULATIONS:
				self.Vtabrms = self.Vtabrms_calc(self.vta,self.vtb)
				self.Vabrms = self.Vabrms_calc(self.va,self.vb)
		except:
			LogUtil.exception_handler()
	...
	def update_power(self):
		...
		try:
			...
			self.S_PCC = self.S_PCC_calc(self.va,self.vb,self.vc,self.ia,self.ib,self.ic)
